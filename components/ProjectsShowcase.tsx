    ...
    >
      <div className="eden-container">
        ...
        <div className="flex flex-col gap-5 w-full max-w-[1200px] mx-auto">
          ...
          <div
            className={`w-full opacity-95 bg-neutral-900 rounded-2xl overflow-hidden transition-all duration-1000 delay-300 ${
              isVisible
            ...
            <div className="w-full px-6 sm:px-8 md:px-10 py-7 flex flex-col gap-5">
              <div className="flex flex-col gap-1.5">
                <div className="text-white text-xl sm:text-2xl font-medium ">
                  Customizable to fit into any Web, Mobile or Desktop App
                </div>
                <div className="text-neutral-400 text-sm sm:text-base font-normal  leading-normal">
                  Design your unique storefront with ease.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
            {/* Card 1 */}
            <div
              className={`w-full opacity-95 bg-neutral-900 rounded-2xl overflow-hidden transition-all duration-1000 delay-500 ${
                isVisible
                  ? "opacity-100 translate-y-0"
            ...
            >
              ...
              <div className="w-full px-6 sm:px-8 md:px-10 py-7 flex flex-col gap-5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="text-neutral-400 text-sm sm:text-base font-normal  leading-normal">
                    Wide intergration support for all your design tools.
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Card 2 */}
            <div
              className={`w-full opacity-95 bg-neutral-900 rounded-2xl overflow-hidden transition-all duration-1000 delay-700 ${
                isVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-16"
              }`}
            >
              ...
              <div className="w-full px-6 sm:px-8 md:px-10 py-7 flex flex-col gap-5">
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="text-neutral-400 text-sm sm:text-base font-normal  leading-normal">
                    Made for designers, developers, and creators alike
                  </div>
                </div>
              </div>
            </div>
